...
open class VitePodLocalizationService: NSObject {
    ...
    static public let  sharedInstance = VitePodLocalizationService()
    @objc public static func ocSharedInstance() -> VitePodLocalizationService {
    ...
    @objc public func setBundleName(_ bundleName: String) {
...
open class VitePodLanguageBundle: Bundle {
    ...
    open class func podLocalizationServiceClass() -> AnyClass {
        return VitePodLocalizationService.self
    }

    override open func localizedString(forKey key: String, value: String?, table tableName: String?) -> String {

        let serviceSharedInstance = (type(of: self).podLocalizationServiceClass() as! VitePodLocalizationService.Type).sharedInstance
